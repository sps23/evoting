...
<html>
	...
	<body>
		<a href="#edit-creator" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-creator" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:creatorInstance, action:'update']" method="PUT" >
